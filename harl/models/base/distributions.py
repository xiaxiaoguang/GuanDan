...
class ProbabilityCategorical(torch.distributions.Categorical):
    """Modify standard PyTorch Categorical."""
    ...
    def mode(self):
        """Return the full probability vector (not sampled actions)."""
        return self.probs
...
class Categorical(nn.Module):
    ...
    def forward(self, x, available_actions=None):
        ...
        return ProbabilityCategorical(logits=x)
